  ...
  return (
    <div className='innovate'>
      ...
      <Container className='my-5'>
        <Row>
          <Col className='d-flex flex-column justify-content-around order-1 order-xl-0'>
            <InnovateCard url={Image1} title="INTELLIGENT PROCESSOR" text="Tellus in hac habitasse platea dictumst vestibulum rhoncus srd mana erti qeueri"/>
            <InnovateCard url={Image2} title="HD SURROUND AUDIO" text="Sagittis eu volutpat odio ante ut diam quam metus dictfacilisis mauris sit am."/>
            <InnovateCard url={Image3} title="STYLISH BEVEL EDGES" text="Dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidid"/>
          </Col>
          ...
          <Col className='d-flex flex-column justify-content-around order-1 order-xl-2'>
